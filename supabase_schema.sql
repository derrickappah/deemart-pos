...
create table public.activity_logs (
  ...
  action_type text not null, -- 'product_create', 'product_update', 'product_delete', 'stock_update', 'sale_create', 'customer_create', etc.
  entity_type text not null, -- 'product', 'sale', 'customer', 'supplier', 'user', 'stock', etc.
  entity_id text, -- ID of the affected entity (can be UUID or bigint, stored as text for flexibility)
  description text not null, -- Human-readable description of the action
  old_values jsonb, -- Previous values (for updates)
  new_values jsonb, -- New values (for creates/updates)
  metadata jsonb, -- Additional context (IP address, browser, etc.)
  branch_id bigint references public.branches(id) on delete set null,
  created_at timestamp with time zone default timezone('utc'::text, now()) not null
);
...
-- Only admins can delete activity logs (for data retention)
